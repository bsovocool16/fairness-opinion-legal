...
1. In Claude Code: `/plugin marketplace add /path/to/fairness-opinion-legal`, then `/plugin install fairness-opinion-legal@fairness-opinion-legal` (user scope). Once, in a terminal: `cd <clone>/fairness-opinion-legal/scripts/redline && npm install`.
